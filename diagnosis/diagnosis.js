...
const QUESTIONS = [
  ...
  { section:"C", type:"ab", text:"年収は高いがワークライフバランス皆無 vs 年収は平均だがワークライフバランスがとれてる", a:"A：年収は高いが、裁量は小さい", b:"B：年収は平均だが、裁量が大きい" },
...
{ section:"C", type:"ab", text:"短期成果型（営業・運用） vs 長期成果型（企画・戦略）", a:"A：短期成果型（営業・運用）", b:"B：長期成果型（企画・戦略）" },
  ...
  { section:"D", type:"text", text:"あなたの仕事を選ぶ上での価値観TOP3を1語ずつ書いてください（例：成長／自由／信頼）" },
  {
