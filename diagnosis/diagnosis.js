...
const QUESTIONS = [
  ...
  { section:"C", type:"ab", text:"年収は高いがワークライフバランス皆無 vs 年収は平均だがワークライフバランスがとれてる", a:"A：年収は高いがワークライフバランス皆無", b:"B：年収は平均だがワークライフバランスがとれてる" },
...
{ section:"C", type:"ab", text:"短期成果型（営業・運用） vs 長期成果型（企画・戦略）", a:"A：短期成果型（営業・運用）", b:"B：長期成果型（企画・戦略）" },
  ...
  { section:"D", type:"text", text:"あなたの仕事を選ぶ上での価値観TOP3を1語ずつ書いてください（例：成長できるか／ワークライフバランスとれる／自分のやりたい仕事/社会貢献できる）" },
  {
